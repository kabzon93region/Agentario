...
} from "./agentario-pass-errors";

describe("agentario-pass-errors", () => {
	it("recognizes both raw and formatted ClinePass subscription messages", () => {
		...
		const sdkFormatted =
			"No access to ClinePass subscription models yet. Subscribe to ClinePass, the low cost open weights model coding plan: https://app.agentario.bot/dashboard/subscription?personal=true";
