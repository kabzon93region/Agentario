...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		lmStudioEmbeddingModelId: config.lmStudioEmbeddingModelId,
		...
		planModeAgentarioModelInfo: convertModelInfoToProtoOpenRouter(config.planModeAgentarioModelInfo),
		planModeAgentarioPassModelId: config.planModeAgentarioPassModelId,
		planModeAgentarioPassModelInfo: convertModelInfoToProtoOpenRouter(config.planModeAgentarioPassModelInfo),
		...
		actModeAgentarioModelInfo: convertModelInfoToProtoOpenRouter(config.actModeAgentarioModelInfo),
		actModeAgentarioPassModelId: config.actModeAgentarioPassModelId,
		actModeAgentarioPassModelInfo: convertModelInfoToProtoOpenRouter(config.actModeAgentarioPassModelInfo),
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		lmStudioEmbeddingModelId: protoConfig.lmStudioEmbeddingModelId,
		...
		planModeAgentarioModelInfo: convertProtoToModelInfo(protoConfig.planModeAgentarioModelInfo),
		planModeAgentarioPassModelId: protoConfig.planModeAgentarioPassModelId,
		planModeAgentarioPassModelInfo: convertProtoToModelInfo(protoConfig.planModeAgentarioPassModelInfo),
		...
		actModeAgentarioModelInfo: convertProtoToModelInfo(protoConfig.actModeAgentarioModelInfo),
		actModeAgentarioPassModelId: protoConfig.actModeAgentarioPassModelId,
		actModeAgentarioPassModelInfo: convertProtoToModelInfo(protoConfig.actModeAgentarioPassModelInfo),
