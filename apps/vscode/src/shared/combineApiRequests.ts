 ...
 * @returns A new array of AgentarioMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: AgentarioMessage[]): AgentarioMessage[] {
	const combinedApiRequests: AgentarioMessage[] = []
