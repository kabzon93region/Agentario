enum AGENTARIO_API_AUTH_ENDPOINTS {
	AUTH = "/api/v1/auth/authorize",
	REFRESH_TOKEN = "/api/v1/auth/refresh",
}

enum AGENTARIO_API_ENDPOINT_V1 {
...
export const AGENTARIO_API_ENDPOINT = {
	...AGENTARIO_API_AUTH_ENDPOINTS,
	...AGENTARIO_API_ENDPOINT_V1,
}
