...
import { ClineSyncStorage } from "./AgentarioStorage"

export interface AgentarioFileStorageOptions {
	/**
 ...
 */
export class AgentarioFileStorage<T = any> extends ClineSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "AgentarioFileStorage", options?: AgentarioFileStorageOptions) {
		super()
