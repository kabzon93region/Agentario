 ...
 *
 * This function processes an array of agentarioMessages objects, looking for sequences
 ...
 * @returns A new array of AgentarioMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: AgentarioMessage[]): AgentarioMessage[] {
	const combinedCommands: AgentarioMessage[] = []
