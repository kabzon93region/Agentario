...
import { AgentarioIgnoreController } from "./AgentarioIgnoreController"
import "should"

describe("AgentarioIgnoreController", () => {
	let tempDir: string
	let controller: AgentarioIgnoreController
	...
	beforeEach(async () => {
		...
		controller = new AgentarioIgnoreController(tempDir)
	...
	describe("Error Handling", () => {
		...
		it("should handle missing .clineignore gracefully", async () => {
			...
			try {
				const controller = new AgentarioIgnoreController(emptyDir)
				await controller.initialize()
