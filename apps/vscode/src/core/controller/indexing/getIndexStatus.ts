...
export async function getIndexStatus(_controller: Controller, _request: EmptyRequest): Promise<CodebaseIndex> {
	return toProtoCodebaseIndex(await CodebaseIndexService.getStatus())
}
