...
export async function rebuildIndex(_controller: Controller, _request: EmptyRequest): Promise<CodebaseIndex> {
	return toProtoCodebaseIndex(await CodebaseIndexService.rebuild())
}
