...
import { AgentarioMessage } from "@shared/proto/agentario/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<AgentarioMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
type PartialMessageCallback = (message: AgentarioMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<AgentarioMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The AgentarioMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: AgentarioMessage): Promise<void> {
