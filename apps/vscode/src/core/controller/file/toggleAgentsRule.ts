import type { ToggleAgentsRuleRequest } from "@shared/proto/agentario/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<AgentarioRulesToggles> {
	...
	return AgentarioRulesToggles.create({
