import type { ToggleWindsurfRuleRequest } from "@shared/proto/agentario/file"
 ...
 */
export async function toggleWindsurfRule(controller: Controller, request: ToggleWindsurfRuleRequest): Promise<AgentarioRulesToggles> {
	...
	return AgentarioRulesToggles.create({ toggles: toggles })
}
