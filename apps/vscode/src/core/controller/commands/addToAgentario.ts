...
export async function addToAgentario(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToAgentario", request.selectedText, filePath, request.language)
