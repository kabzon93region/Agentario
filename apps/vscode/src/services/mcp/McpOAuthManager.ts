...
//  - Writes scope to ONE server's `oauth` key via @agentario/core's
...
//    @agentario/core's authorizeMcpServerOAuth, which binds a local loopback
 ...
 * providers. Matches @agentario/core's DEFAULT_HTTP_MCP_REDIRECT_URL — the actual
 ...
 * @agentario/core defaults; extras tolerate concurrent flows from other Cline
 ...
 * reads/writes the shared settings file in @agentario/core's format.
 *
 ...
 * HTTP-callback authorization flow via @agentario/core.
 */
export class McpOAuthManager {
	 ...
	 *
	 * Delegates to @agentario/core's authorizeMcpServerOAuth (the exact flow the
