...
import type { AgentarioError } from "../AgentarioError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | AgentarioError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or AgentarioError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | AgentarioError, properties?: Record<string, unknown>): void
