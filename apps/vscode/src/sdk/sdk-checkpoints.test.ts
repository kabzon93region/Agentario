...
const userTask = (text: string, ts: number): AgentarioMessage => ({
	ts,
	type: "say",
	say: "task",
	text,
...
const userFeedback = (text: string, ts: number): AgentarioMessage => ({
	ts,
	type: "say",
	say: "user_feedback",
	text,
...
const assistant = (text: string, ts: number): AgentarioMessage => ({
	ts,
	type: "say",
	say: "text",
	text,
...
const followupAsk = (text: string, ts: number): AgentarioMessage => ({
	ts,
	type: "ask",
	ask: "followup",
	text,
...
const checkpointRow = (runCount: number, ts: number, ref = "old-ref"): AgentarioMessage => ({
	ts,
	type: "say",
