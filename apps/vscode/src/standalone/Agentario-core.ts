...
async function main() {
	log("\n\n\nStarting agentario-core service...\n\n\n")
...
function setupHostProvider(extensionContext: any, extensionDir: string, dataDir: string) {
	...
	// agentario-core expects the binaries to be unpacked in the directory where it is running.
...
/**
 * Gracefully shutdown the agentario-core process by:
...
Usage: node agentario-core.js [options]
