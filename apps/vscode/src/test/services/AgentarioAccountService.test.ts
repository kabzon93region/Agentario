...
describe("AgentarioAccountService.fetchUserRemoteConfig", () => {
	let service: AgentarioAccountService
	...
	beforeEach(() => {
		...
		service = new AgentarioAccountService()
	})
...
describe("AgentarioAccountService.fetchFeaturebaseToken", () => {
	let service: AgentarioAccountService
	let sandbox: sinon.SinonSandbox
