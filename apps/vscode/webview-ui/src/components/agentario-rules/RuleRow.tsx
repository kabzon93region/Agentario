...
import { DeleteSkillRequest, RuleFileRequest } from "@shared/proto/index.agentario"
...
const RuleRow: React.FC<{
	...
	onDeleteSkill?: () => void
	description?: string
}> = ({ rulePath, enabled, isGlobal, toggleRule, ruleType, isRemote = false, alwaysEnabled = false, onDeleteSkill, description }) => {
	...
	return (
		<div className="mb-2.5">
			<div className="flex items-center px-2 py-4 rounded bg-text-block-background max-h-4">
				<span className="flex-1 overflow-hidden break-all whitespace-normal flex items-center mr-1" title={ruleType === "skill" && description ? description : rulePath}>
