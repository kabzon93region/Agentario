...
export function useScrollBehavior(
	...
	visibleMessages: AgentarioMessage[],
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<AgentarioMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: AgentarioMessage | null = null
