...
/**
 * AgentarioLogoVariable component renders the Cline logo with automatic theme adaptation
 ...
 */
const AgentarioLogoVariable = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
...
export default AgentarioLogoVariable
