...
export interface AgentarioAuthContextType {
	clineUser: ClineUser | null
	organizations: UserOrganization[] | null
	activeOrganization: UserOrganization | null
}

export const AgentarioAuthContext = createContext<AgentarioAuthContextType | undefined>(undefined)
...
export const ClineAuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	useEffect(() => {
		console.log("Extension: AgentarioAuthContext: user updated:", user?.uid)
	}, [user?.uid])
...
export const useClineAuth = () => {
	const context = useContext(AgentarioAuthContext)
