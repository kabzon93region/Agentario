...
title: "Agent"
sidebarTitle: "Agent"
description: "API reference for Agent / AgentRuntime from @agentario/agents."
---

`Agent` is an alias for `AgentRuntime` from `@agentario/agents`.

```typescript
import { Agent, AgentRuntime, createAgent, createAgentRuntime } from "@agentario/sdk"
```
