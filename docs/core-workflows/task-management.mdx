...
- System instructions that guide Cline's behavior (including [Cline Rules](/customization/agentario-rules))
...
If your starting context seems high even for simple prompts, add a [`.AgentarioIgnore`](/customization/AgentarioIgnore) file to exclude dependencies, build artifacts, and other files Cline doesn't need. This can dramatically reduce your baseline token usage.
