...
export type { AgentarioCoreSettingsApi } from "../settings";
...
export interface AgentarioCoreAutomationOptions {
...
export interface AgentarioCoreAutomationApi {
	start(): Promise<void>;
	stop(): Promise<void>;
...
export type AgentarioCoreListHistoryOptions = SessionHistoryListOptions;

export interface AgentarioCoreStartInput
...
export interface AgentarioCoreOptions {
	/**
	...
	/**
	 * Feature flags service for this AgentarioCore instance.
	...
	/**
	 * Enables file-based and event-driven automation through this AgentarioCore
	 * instance. When configured, callers use `cline.automation.*` instead of
	 * constructing cron services directly.
	 */
	automation?: boolean | AgentarioCoreAutomationOptions;
	/**
	 ...
	 *     `@agentario/core/hub` for the scheduler
	 */
	fetch?: typeof fetch;
	/**
...
export interface StartSessionBootstrap {
	applyToStartSessionInput(
		input: AgentarioCoreStartInput,
	): Promise<AgentarioCoreStartInput> | AgentarioCoreStartInput;
