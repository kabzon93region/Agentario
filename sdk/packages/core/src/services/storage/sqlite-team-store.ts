...
import { loadSqliteDb, nowIso, type SqliteDb } from "@agentario/shared/db";
import { resolveDbDataDir } from "@agentario/shared/storage";
...
export class SqliteTeamStore implements TeamStore {
	...
	private ensureSchema(db: SqliteDb): void {
		...
		// Session/schedule schemas use separate migration paths in @agentario/shared.
		db.exec(`
