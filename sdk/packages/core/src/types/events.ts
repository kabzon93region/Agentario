...
export interface SessionTeamProgressEvent {
	sessionId: string;
	teamName: string;
	lifecycle: import("@agentario/shared").TeamProgressLifecycleEvent;
	summary: import("@agentario/shared").TeamProgressSummary;
}
...
export type CoreSessionEvent =
	...
	| {
			...
			payload: {
				sessionId: string;
				event: import("@agentario/shared").AgentEvent;
